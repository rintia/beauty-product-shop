...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-[#FACBEA] text-base-content">
  <nav>
...
<footer className="footer px-10 py-4  bg-[#FACBEA] text-base-content border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p>HerBeauty Industries Ltd. <br/>Providing reliable cosmetics since 1992</p>
  </aside> 
